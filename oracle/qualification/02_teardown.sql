...
--
-- Applied by tests/oracle_fixtures.py using the same '--#' separators. Every
...
--# drop_package
BEGIN EXECUTE IMMEDIATE 'DROP PACKAGE employee_report'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -4043 THEN RAISE; END IF; END;
